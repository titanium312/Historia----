 ...
 *   - datosClinicos (opcional, con laboratorios y pruebas rápidas)
 */
function adolescencia(data) {
    ...
    // ============================================================
    function fechaAnticonceptivos(fechaBase) {
    ...
    return {
        ...
        historia_pym_adolescencia: [
            {
                ...
                autonomia_funcionamiento_psicosocial_adolecencia: 'No se evidencia problemas de comportamiento, buena relación con sus pares.',
                autonomia_componentes_adolecencia: 'Se evidencia Capacidad suficiente para trazarse metas, objetivos propios y adecuado proceso de regulación de emociones.',
                autonomia_factores_de_desempeno_adolecencia: 'Adecuado acompañamiento familiar buena distribución del tiempo.',
                practicas_alimentarias_observaciones_adolecencia: 'Refiere consumo y hábitos alimentarios adecuados, no se evidencia ingesta excesiva o deficiente de calorías o nutrientes.',
                estructuras_dentomaxilofaciales_adolecencia: 'Estructuras dentomaxilofaciales sin alteraciones evidentes al examen físico, procesos de masticación, deglución, habla y fonación sin déficit o alteración.',
                auditiva_comunicativa_observaciones_adolecencia: 'Se evidencia integridad del oído izquierdo y derecho conservada, funciones de la articulación, voz, habla y desempeño comunicativo sin alteraciones.',
                valoracion_salud_visual_adolecencia: 'Durante la exploración oftalmoscópica no se evidencia alteraciones oculares de la conjuntiva, cornea o retina ni derecha ni izquierda.',
                salud_sexual_observaciones_adolecencia: 'No se evidencia signos de violencia sexual y de género, se descarta la presencia de criptorquidia y/o EPI o hipospadias.',
                ...
                laboratorio_clinico_resultado_hemoglobina_adolescencia: hemoglobinaVal !== null ? String(hemoglobinaVal) : '0',
                ...
                laboratorio_paraclinico_laboratorio_prueba_treponemica_rapida_sifilis_adolescencia: sifilisMap.tieneResultado ? sifilisMap.codigo : '2',
                laboratorio_paraclinico_laboratorio_fecha_prueba_treponemica_rapida_sifilis_adolescencia: sifilisMap.tieneResultado ? fechaConsulta : '07/28/2026',
                laboratorio_clinico_resultado_prueba_rapida_VIH_adolescencia: vihMap.tieneResultado ? vihMap.codigo : '2',
                laboratorio_paraclinico_laboratorio_fecha_prueba_rapida_VIH_adolescencia: vihMap.tieneResultado ? fechaConsulta : '07/28/2026',
                laboratorio_paraclinico_laboratorio_hepatitis_b_adolescencia: hepBMap.tieneResultado ? hepBMap.codigo : '1',
                laboratorio_paraclinico_laboratorio_hepatitis_b_fecha_adolescencia: hepBMap.tieneResultado ? fechaConsulta : '07/28/2026',
        ...
        resolucion4505: [
            {
                ...
                // Si es mujer y >10 años, asignar valores válidos (21, 1800-01-01, etc.)
                // de lo contrario, mantener 0 y 1845-01-01 (no aplica)
                ...
                calidad_muestra_citologia_cervicouterina: esMujerMayor10 ? 0 : 0, // CORREGIDO: siempre 0 cuando resultado=21
        ...
        diagnostico_ingreso_observaciones_historia: 'Paciente en control de adolescencia. Sin alteraciones significativas.',
        ...
        diagnostico_principales_observaciones_consulta_externa: 'Control de adolescente sano. Sin patologías activas.',
    };
}
