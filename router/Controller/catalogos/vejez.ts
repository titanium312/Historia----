 ...
 */
function restarUnAnio(fechaStr: string): string {
  if (!fechaStr || fechaStr === '1845-01-01') return '1845-01-01';
 ...
 */
function ajustarLaboratorio(
  valor: any,
  fecha: any,
  fechaAdmision: string,
  esHemoglobina: boolean = false
  ...
  if (isNaN(valorNum)) valorNum = esHemoglobina ? 0 : 998;
